        ...
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="性别" prop="jianliSexTypes">
                        <el-select v-model="ruleForm.jianliSexTypes" :disabled="ro.jianliSexTypes" placeholder="请选择性别">
                            <el-option
                                v-for="(item,index) in jianliSexTypesOptions"
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=jianli_sex_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.jianliSexTypesOptions = data.data.list;
                    }
                });
                this.$http({
